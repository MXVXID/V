...
# ==================================================
# Link Hosting Kalian
mxvx.my.id="raw.githubusercontent.com/fisabiliyusri/Mantap/main/ssh"
...
curl https://${mxvx.my.id}/nginx.conf > /etc/nginx/nginx.conf
curl https://${mxvx.my.id}/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://${mxvx.my.id}/index.html1"
