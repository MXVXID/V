...
cd
#install tools/alat
wget https://raw.githubusercontent.com/MXVXID/V/main/install-tools.sh && chmod +x install-tools.sh && ./install-tools.sh
#
#Instal Xray
...
echo -e "    SCRIPT MXVNET Xray"  | tee -a log-install.txt
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
